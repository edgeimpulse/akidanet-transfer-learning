...
from ei_tensorflow.conversion import get_concrete_function
...
def get_callbacks(mode, best_model_path, object_detection_last_layer, is_enterprise_project, max_training_time_s):
    if mode == 'object-detection':
        if (object_detection_last_layer == 'fomo'):
            ...
            return [ handle_training_deadline_callback ]
        return []
    else:
        ...
        return [ model_checkpoint_callback, handle_training_deadline_callback ]
